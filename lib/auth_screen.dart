...
class _AuthScreenState extends State<AuthScreen> with SingleTickerProviderStateMixin {
  ...
  final _guideLanguagesController = TextEditingController();
  ...
  void dispose() {
    ...
    _guideLanguagesController.dispose();
  ...
  Future<void> _guideSignup() async {
    ...
    final languages = _guideLanguagesController.text.trim();
    final priceStr = _guidePricePerDayController.text.trim();
    final bio = _guideBioController.text.trim();

    if (name.isEmpty || email.isEmpty || password.isEmpty || division.isEmpty || languages.isEmpty || priceStr.isEmpty) {
  ...
  void _clearGuideFields() {
    ...
    _guideLanguagesController.clear();
        ...
        child: AnimatedCrossFade(
          ...
          secondChild: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              TextField(controller: _guideLanguagesController, decoration: InputDecoration(labelText: 'Languages * (comma separated)', prefixIcon: const Icon(Icons.translate), border: OutlineInputBorder(borderRadius: BorderRadius.circular(12)))),
              const SizedBox(height: 16),
