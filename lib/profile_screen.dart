...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // ✅ FIXED: Works on web, Android, iOS — keeps original photo quality
  // (no maxWidth/maxHeight/imageQuality means image_picker does not
  // re-encode or downscale the photo at all)
